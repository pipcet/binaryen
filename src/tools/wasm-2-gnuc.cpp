...
int main(int argc, const char *argv[]) {
  ...
  output.getStream() << "#include \"wasm.h\"\n";
  output.getStream() << "typedef int i32;\n";
  output.getStream() << "typedef long i64;\n";
  output.getStream() << "typedef float f32;\n";
  output.getStream() << "typedef double f64;\n";

  std::string ret = cvisit.visitModule(&wasm);

  output.getStream() << ret;
